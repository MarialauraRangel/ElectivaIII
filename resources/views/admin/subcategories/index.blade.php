				...
				<div class="row">
					<div class="col-12">
						<div class="text-right">
							<a href="{{ route('subcategorias.create') }}" class="btn btn-primary">Agregar</a>
						</div>
									...
									<tr>
										...
										<td>
											<div class="btn-group" role="group">
												...
												<button type="button" class="btn btn-danger btn-sm bs-tooltip" title="Eliminar" onclick="deleteSubcategory('{{ $subcategory->slug }}')"><i class="fa fa-trash"></i></button>
											</div>
										</td>
									</tr>
									@endforeach
