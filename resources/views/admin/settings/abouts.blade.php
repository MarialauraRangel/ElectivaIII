						...
						<form action="{{ route('nosotros.update') }}" method="POST" class="form" id="formAbout" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="form-group col-12">
									<label class="col-form-label">Nosotros<b class="text-danger">*</b></label>
									<textarea class="form-control @error('about') is-invalid @enderror" name="about" required placeholder="Ingrese el texto de nosotoros" id="content-about" rows="6">{{ $setting->about }}</textarea>
								</div>
